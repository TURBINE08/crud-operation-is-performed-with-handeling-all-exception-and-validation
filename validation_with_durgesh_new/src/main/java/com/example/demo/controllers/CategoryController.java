...
{ 
	...
	public ResponseEntity<ApiResponse> deleteCategory(@PathVariable Integer catId)
	{
		...
		return new ResponseEntity<ApiResponse>(new ApiResponse("category is deleted successfully !! ", "deleted", true), HttpStatus.OK);
	}
	//get
	...
	{
		List<CategoryDto> cdto =  this.categoryService.getCategories();
